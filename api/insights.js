export default async function handler(req, res) {
  ...
  const response = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({
      ...
      max_tokens: 1024,
      system:
        "You are a hospitality business analyst for Celebiz Lounge, a South Sudanese restaurant and bar. Analyze the performance data provided and give 5-6 sharp, actionable bullet-point insights. Be specific with numbers. Use SSP (South Sudanese Pound). No headers, just bullet points starting with •.",
